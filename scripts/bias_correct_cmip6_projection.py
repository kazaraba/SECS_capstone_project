...
DATA_DIR = Path("Projected_SSP5-8.5/data")  # SSP5-8.5-specific; parameterize if reused for SSP2-4.5

ERA5_DAILY = {
    "seville": Path("Historical/eda_outputs/seville/seville_daily.csv"),
    "larissa": Path("Historical/eda_outputs/larissa/larissa_daily.csv"),
}
CMIP6_HISTORICAL = {
