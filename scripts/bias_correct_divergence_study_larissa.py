"""
Bias-correct the extended 2026-2100 Larissa CMIP6 pulls for both scenarios (SSP2-4.5 and
SSP5-8.5), for the scenario-divergence study. Larissa counterpart of
bias_correct_divergence_study_seville.py -- identical methodology (Equidistant CDF Matching,
fixed 1990-2014 fitting period, reused cmcc_esm2 historical run for both scenarios), just Larissa's
own ERA5 reference and historical CSV.
"""
...
HIST_CSV = ROOT / "Projected_SSP5-8.5" / "data" / "larissa_cmip6_historical_1990_2014.csv"

LT_DIR = ROOT / "Projected_Long_Term_2100"

SCENARIOS = {
    "ssp245": {
        "raw": LT_DIR / "SSP2-4.5" / "data" / "larissa_cmip6_ssp245_2026_2100.csv",
        "out": LT_DIR / "SSP2-4.5" / "data" / "larissa_cmip6_cmcc_esm2_ssp245_2026_2100_biascorrected.csv",
    },
    "ssp585": {
        "raw": LT_DIR / "SSP5-8.5" / "data" / "larissa_cmip6_ssp585_2026_2100.csv",
        "out": LT_DIR / "SSP5-8.5" / "data" / "larissa_cmip6_cmcc_esm2_ssp585_2026_2100_biascorrected.csv",
    },
}
